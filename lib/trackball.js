 ...
 */
THREE.OrbitControls.prototype.showAxes = function() {
 ...
 * @param angle (optional) - the angle to rotate by
 */
THREE.OrbitControls.prototype.rotateRight = function(angle) {
  if (angle === undefined) {
    angle = 2 * Math.PI / 60 / 60 * this.autoRotateSpeed;
  }
  this.thetaDelta += angle;
 ...
 * @param angle (optional) - the angle to rotate by
 */
THREE.OrbitControls.prototype.rotateDown = function(angle) {
  if (angle === undefined) {
    angle = 2 * Math.PI / 60 / 60 * this.autoRotateSpeed;
  }
  this.phiDelta += angle;
 ...
 */
THREE.OrbitControls.prototype.zoomIn = function(zoomScale) {
 ...
 * @param zoomScale (optional) - the scale to zoom in by
 */
THREE.OrbitControls.prototype.zoomOut = function(zoomScale) {
  if (zoomScale === undefined) {
    zoomScale = Math.pow(0.95, this.userZoomSpeed);
  }
  this.scale *= zoomScale;
