...
function cnclib(userOptions)
{
	...
	function findBestPath()
	{
		...
		for (i = 0; i < 1000; i++)
		{
			...
			{
				if (bestPartOrder && (bestResult - sum) / that.options.maxJogSpeed < 1 / 600) // change less than 1/10th second in jog time
				{
					console.log("stopping trials soon since solution improvement was neglicable");
